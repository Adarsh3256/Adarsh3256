...
public ModelAndView showCustomerIssue(ModelMap model, @RequestParam String issueid, @RequestParam St
ring option) { 
IssueDetail issueDetail = new IssueDetail(); 
 
ModelAndView modelAndView = new ModelAndView(); 
 
// Type Your Code here if(option.equals("ri")){ 
...
public ModelAndView raiseIssue(ModelMap model, @RequestParam String issueReportDate, @RequestParam Str
ing custId, 
